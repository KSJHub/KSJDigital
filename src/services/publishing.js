export const publishQueue = [
  {
    ...
    requester: 'Taj',
    updated: 'Today',
    fields: ['Hero Title', 'Hero Subtitle', 'Primary Button'],
    risk: 'Low',
    target: 'TwoToneTaj website content',
  },
  {
    id: 'pub-002',
    website: 'TwoToneTaj',
    title: 'Community page copy',
    status: 'Draft Saved',
    requester: 'Taj',
    updated: 'Yesterday',
    fields: ['Community Intro', 'Discord CTA'],
    risk: 'Low',
    target: 'TwoToneTaj website content',
  },
  {
    id: 'pub-003',
    website: 'Goliath',
    title: 'Launch page wording',
    status: 'Client Editing',
    requester: 'Goliath Admin',
    updated: '2 days ago',
    fields: ['Launch Title', 'Launch Text'],
    risk: 'Medium',
    target: 'Goliath website content',
  },
]
