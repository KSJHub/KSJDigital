const ownerWorkspace = {
  ...
  content: { path: '/owner/content', label: 'Content', group: 'Website Management' },
...
const clientWorkspace = {
  ...
  content: { path: '/client/content', label: 'Content', group: 'My Website', capability: 'website', any: ['canEdit'] },
