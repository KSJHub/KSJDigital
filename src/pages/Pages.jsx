...
import { clients, clientStats, mediaItems, ownerStats, pages, tickets, websites } from '../services/mockData.js'
...
export function PublishPage({ client = false }) {
  const rows = [['Homepage update','TwoToneTaj','Waiting Review'],['About wording','TwoToneTaj','Draft'],['Community text','TwoToneTaj','Approved']]
