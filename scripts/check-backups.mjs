...
assert.match(router, /requireAssurance\(2\)/)
assert.match(router, /router\.post\('\/', requireStepUp/)
assert.match(router, /router\.post\('\/prune', requireStepUp/)
assert.match(router, /router\.patch\('\/settings', requireStepUp/)
assert.match(router, /router\.post\('\/:backupId\/restore', requireStepUp/)
assert.match(router, /router\.delete\('\/:backupId', requireStepUp/)
